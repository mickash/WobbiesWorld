...
#'       the maze, and returns an actionList, with the fields 'move' giving the
#'       move to make (2=down,4=left,6=right,8=up) and 'control' which is simply
#'       a copy of the controller, potentially updated.
#'
...
#' @param control The control system. See above/below for details.
